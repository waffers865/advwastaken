...
const Home: NextPage = () => {
  return (
    <div className="flex min-h-screen bg-[#111] flex-col items-center justify-center py-2">
      <Head>
        <title>ADV</title>
        <link rel="shortcut icon" href="/logo.png" />
      </Head>

      <p className="pop text-xl mb-8 text-[#eee]"><span className="text-blue-500"> Sponsored</span>  by</p>
      <Link href="https://wheregroup.com/">
      <div className="rounded-2xl h-auto w-80 py-12 px-8 flex flex-col space-y-8 items-center justify-center shadow-2xl">
        ...
        <svg id="Layer_1" data-name="Layer 1" viewBox="0 0 499.13 76.26" height={30}>
