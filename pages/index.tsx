...
const Home: NextPage = () => {
  return (
    <div className="flex min-h-screen bg-cover bg-center bg-[url('/bg.gif')] bg-[#111] bg-fixed flex-col">
	  ...
	  <p className="pop text-sm opacity-60">Your ip is not in my discord-frnds-ip-list, so, Congrats you found my 2/5 Personal Webapp, Here instead of static/still background, I use animated backgrounds. Hope you like it.</p>
