  ...
  return (
    ...
    <div className="bg-[#18191B] min-h-screen w-full flex flex-col items-center justify-center px-8">
      <Head>
        ...
        <p className="text-sm underline pop decoration-[#CB4E38] text-[#eee]">Don't think I care about some people whom I gave special routes yo. I choose to remove them from my entire life ;) <br/>Saionara, may the <span className="text-[#CB4E38]"> godly </span> flame above burn all the relations with them 🙏 and the email "advwastaken@protonmail.com".</p>
    </div>
    </div>
  );
};
