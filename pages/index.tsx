...
const Home: NextPage = () => {
  return (
    <div className="flex min-h-screen bg-cover bg-center bg-[url('/bg.gif')] bg-[#111] bg-fixed flex-col">
	  ...
	  <p className="pop text-xs opacity-30 items-center">Your ip is not in my discord-frnds-ip-list, so, Congrats you found my 2/5 Personal Webapp, Here instead of static/still background, I use animated backgrounds. Hope you like it.</p>
<p className="pop text-sm opacity-60 flex">This WebApp still at 8K views, raise it up yo <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="orange" className="px-2 bi bi-fire" viewBox="0 0 16 16">
